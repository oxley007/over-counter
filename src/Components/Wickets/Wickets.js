      ...
      <div className="row">
        <div className="col-9">
          ...
          <div className="col-3 advice-total-div">
            ...
            <button className="text-button" onClick={this.props.removeWicket}>-</button> {this.props.wickets} <button className="text-button" onClick={this.props.addWicket}>+</button></p>
            </div>
          </div>
            <hr />
      </div>
